            ...
            <div className="animate-on-load opacity-0 transition-opacity duration-700">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {project.tags.map((tag: string) => (
                  <span
                    key={tag}
                    className="inline-flex items-center rounded-full bg-navy-800 px-2.5 py-0.5 text-xs font-medium text-gold-300 border border-gold-500/20"
                  >
                  ...
                  <div className="relative bg-navy-800 p-6 rounded-lg border border-gold-500/20">
                    ...
                    <div className="space-x-2">
                      {project.technologies.map((tech: string, index: number) => (
                        <span
                          key={index}
                          className="inline-flex items-center rounded-md bg-navy-900 px-3 py-1 text-sm font-medium text-gold-300 border border-gold-500/20"
                        >
                          {tech}
                        </span>
                      ))}
                  ...
                  <div className="relative bg-navy-800 p-6 rounded-lg border border-gold-500/20">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      {project.gallery.map((image: string, index: number) => (
                        <div key={index} className="rounded-lg overflow-hidden border border-gold-500/20">
                          <img
