        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="project-card opacity-0 translate-y-10 transition-all duration-700">
            <ProjectCard
              ...
              description="The College Predictor website helps students estimate their chances of admission into various colleges based on entrance exam scores, category, and preferences. It provides personalized college suggestions, eligibility insights, and streamlines the decision-making process for aspirants."
              tags={["HTML", "CSS", "Javascript"]}
              image="https://play-lh.googleusercontent.com/0EdbRA6bnqKtSaChxft4C-cvYun67_9cHxX6FlEI84lz82L2vDBCPRvf3eb8QFRjeQQ=w240-h480-rw"
          ...
          <div className="project-card opacity-0 translate-y-10 transition-all duration-700">
            <ProjectCard
              ...
              description="The Carbon Footprint Tracker website helps users monitor and reduce their carbon emissions by tracking daily activities. It offers insights, tips, and reports to promote eco-friendly habits and support a sustainable lifestyle through personalized environmental impact analysis."
              tags={["React JS", "Firebase", "Next JS", "Tailwind CSS"]}
              image="https://miro.medium.com/v2/resize:fit:1400/1*BKS2ONp4X4vbqm7nt9l5aw.png"
              github="https://github.com/OmB-tech/"
            />
          </div>
